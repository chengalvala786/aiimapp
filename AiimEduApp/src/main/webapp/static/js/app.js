...
config(['$routeProvider', function($routeProvider) {
	...
	.when('/personalInfo', {
		templateUrl : 'templates/personal_info.html?id=v14',
		controller  : 'UserController'
	})
	.when('/', {
		templateUrl : 'templates/login.html?id=v14',
		controller  : 'UserController'
	})
	.when('/eductionInfo', {
		templateUrl : 'templates/eduction_info.html?id=v14',
		controller  : 'UserController'
	}).when('/createUser', {
		templateUrl : 'templates/user_register.html?id=v14',
		controller  : 'UserController'
	})
	// route for the about page
	.when('/workInfo', {
		templateUrl : 'templates/work_info.html?id=v14',
		controller  : 'UserController'
	})// route for the about page
	.when('/additionalInfo', {
		templateUrl : 'templates/additional_info.html?id=v14',
		controller  : 'UserController'
	}).when('/review', {
		templateUrl : 'templates/review.html?id=v14',
		controller  : 'UserController'
	}).when('/resultpage', {
		templateUrl : 'templates/resultpage.html?id=v14',
		controller  : 'UserController'
	}).when('/adminMain', {
		templateUrl : 'templates/admin_main.html?id=v14',
		controller  : 'AdminController'
	}).when('/regUsers', {
		templateUrl : 'templates/admin_reguser.html?id=v14',
		controller  : 'RegController'
	}).when('/completedApps', {
		templateUrl : 'templates/admin_completedapps.html?id=v14',
		controller  : 'AppCmplController'
	}).when('/incompleteApps', {
		templateUrl : 'templates/admin_incompleteapps.html?id=v14',
		controller  : 'AdminController'
	});
...
App.run(function($templateCache ,$http) {
	  $http.get('templates/personal_info.html?id=v14', {cache:$templateCache});
	  $http.get('templates/eduction_info.html?id=v14', {cache:$templateCache});
	  $http.get('templates/work_info.html?id=v14', {cache:$templateCache});
	  $http.get('templates/user_register.html?id=v14', {cache:$templateCache});
	  $http.get('templates/additional_info.html?id=v14', {cache:$templateCache});
	  $http.get('templates/review.html?id=v14', {cache:$templateCache});
	  $http.get('templates/resultpage.html?id=v14', {cache:$templateCache});
	  $http.get('templates/admin_main.html?id=v14', {cache:$templateCache});
	  $http.get('templates/admin_reguser.html?id=v14', {cache:$templateCache});
	  $http.get('templates/admin_completedapps.html?id=v14', {cache:$templateCache});
	  $http.get('templates/admin_incompleteapps.html?id=v14', {cache:$templateCache});
