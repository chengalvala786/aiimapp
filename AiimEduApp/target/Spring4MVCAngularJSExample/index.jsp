...
<link href="<c:url value='/static/css/app.css?id=v6' />" rel="stylesheet"></link>
<link href="<c:url value='/static/css/angular-material.min.css' />"
	rel="stylesheet"></link>
<link href="<c:url value='/static/css/print.css?id=v6'  />"
...
<script src="<c:url value='/static/js/angular-animate.js' />"></script>
	...
	<script src="<c:url value='/static/js/app.js?id=v6' />"></script>
	<script src="<c:url value='/static/js/directive.js' />"></script>
	<script src="<c:url value='/static/js/jquery.blockUI.js' />"></script>
	
	<script src="<c:url value='/static/js/service/user_service.js?id=v6' />"></script>
	<script src="<c:url value='/static/js/service/register_service.js?id=v6' />"></script>
	<script
		src="<c:url value='/static/js/controller/user_controller.js?id=v6' />"></script>
		<script
		src="<c:url value='/static/js/ng-file-upload.min.js' />"></script>
<script
		src="<c:url value='/static/js/ng-file-upload-shim.js' />"></script>
		<script
		src="<c:url value='/static/js/angular-base64.min.js' />"></script>

<script
		src="<c:url value='/static/js/ui-bootstrap-tpls-0.14.3.js' />"></script>
<script>
